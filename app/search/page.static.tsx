...
// real page.tsx (which reads ?city= etc. server-side per request) afterwards.
// Static export has no server to read the query string at request time, so this
// renders on the client instead — see components/search-client.tsx.
