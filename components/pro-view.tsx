...
/**
 * Pure render of the Pro dashboard. Fed by an already-computed ProSummary so it
 * works identically whether that came from a server component reading
 * `searchParams` (normal deployment) or a client component reading
